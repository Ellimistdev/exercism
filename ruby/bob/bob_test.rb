...
class BobTest < Minitest::Test
  ...
  def test_talking_forcefully
    ...
    assert_equal 'Whatever.', Bob.hey(remark), "Bob hears 'Let\'s go make out behind the gym!', and.."
  end
  ...
  def test_forceful_question
    ...
    assert_equal 'Whoa, chill out!', Bob.hey(remark), "Bob hears 'WHAT THE HELL WERE YOU THINKING?', and.."
  end
  ...
  def test_shouting_with_no_exclamation_mark
    remark = 'I HATE YOU'
    assert_equal 'Whoa, chill out!', Bob.hey(remark), "Bob hears 'I HATE YOU', and.."
  end
  ...
  def test_multiple_line_question
    ...
    assert_equal 'Whatever.', Bob.hey(remark), "Bob hears '\nDoes this cryogenic chamber make me look fat?\nno', and.."
  end
